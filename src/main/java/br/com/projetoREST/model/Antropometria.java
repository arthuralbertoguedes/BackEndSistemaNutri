...
public class Antropometria {
		...
		public Antropometria(int altura, int peso, int imc, int idade, String observacao, int bracoRelaxadoDireito,
				int bracoContraidoDireito, int bracoRelaxadoEsquerdo, int bracoContraidoEsquerdo,
				int antebracoContraidoDireito, int antebracoRelaxadoDireito, int antebracoRelaxadoEsquerdo,
				int antebracoContraidoEsquerdo, int panturrilhaEsquerda, int panturrilhaDireita, int coxaEsquerda,
				int coxaDireita, int pescoco, int ombro, int peitoral, int cintura) {
